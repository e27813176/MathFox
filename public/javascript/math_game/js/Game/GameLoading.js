...
export default class extends Phaser.State {
  ...
  loadCatchBugPage() {
    let audioPath = path_prefix + 'assets/audio/';
    this.load
      .image('BG', '/assets/CatchBugPage/CatchBugPageBG.jpg')
      .atlasJSONArray('FlyingBug', '/assets/CatchBugPage/FlyingBug.png', '', require('../../assets/CatchBugPage/FlyingBug.json'))
      .atlasJSONArray('FoxStanding', '/assets/CatchBugPage/FoxStanding.png', '', require('../../assets/CatchBugPage/FoxStanding.json'))
      .atlasJSONArray('FoxCatching', '/assets/CatchBugPage/FoxCatching.png', '', require('../../assets/CatchBugPage/FoxCatching.json'))
      .atlasJSONArray('FoxFalling', '/assets/CatchBugPage/FoxFalling.png', '', require('../../assets/CatchBugPage/FoxFalling.json'))
      .atlasJSONArray('FoxHitting001', '/assets/CatchBugPage/FoxHitting001.png', '', require('../../assets/CatchBugPage/FoxHitting001.json'))
      .atlasJSONArray('FoxHitting', '/assets/CatchBugPage/FoxHitting.png', '', require('../../assets/CatchBugPage/FoxHitting.json'))
      .atlasJSONArray('FoxStandUp', '/assets/CatchBugPage/FoxStandUp.png', '', require('../../assets/CatchBugPage/FoxStandUp.json'))
      .atlasJSONArray('FruitDrop', '/assets/CatchBugPage/FruitDrop.png', '', require('../../assets/CatchBugPage/FruitDrop.json'))
      .atlasJSONArray('Board', '/assets/CatchBugPage/Board.png', '', require('../../assets/CatchBugPage/Board.json'))
      .atlasJSONArray('TutorialText', '/assets/CatchBugPage/TutorialText.png', '', require('../../assets/CatchBugPage/TutorialText.json'))
      .atlasJSONArray('TaskBoard', '/assets/CatchBugPage/TaskBoard.png', '', require('../../assets/CatchBugPage/TaskBoard.json'))
      .atlasJSONArray('Panel', '/assets/CatchBugPage/Panel.png', '', require('../../assets/CatchBugPage/Panel.json'))
      .audio('GetMedal', GetMedal)
